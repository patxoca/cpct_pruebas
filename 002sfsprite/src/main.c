...
const u8 sprite_nave[SHIP_WIDTH * SHIP_HEIGHT] = {
	...
	0xCC, 0xCC, 0x44, 0x88, 0xCC, 0xCC,
	0x00, 0xCC, 0x44, 0x88, 0xCC, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

const u8 sprite_nave_left[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x00, 0x14, 0x64, 0x98, 0x88, 0x00,
	0x00, 0x00, 0xCC, 0xCC, 0x00, 0x00,
	0x00, 0x00, 0x34, 0x38, 0x00, 0x80,
	0x00, 0x00, 0x98, 0x64, 0x00, 0x80,
	0x00, 0x00, 0x44, 0x88, 0x00, 0x20,
	0x40, 0x00, 0x44, 0x88, 0x00, 0x88,
	0x40, 0x00, 0xEC, 0x89, 0x00, 0x88,
	0x10, 0x14, 0x64, 0x98, 0x28, 0x88,
	0x44, 0x14, 0x6C, 0x9C, 0x28, 0x88,
	0x44, 0x6C, 0x6C, 0x9C, 0x9C, 0x88,
	0x14, 0xCC, 0xCC, 0xCC, 0xCC, 0x28,
	0x44, 0xCC, 0xCC, 0xCC, 0xCC, 0x88,
	0x44, 0xCC, 0x44, 0x88, 0xCC, 0xDC,
	0x00, 0xCC, 0x44, 0x88, 0xCC, 0xFC,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

const u8 sprite_nave_left_down[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x00, 0x00, 0x98, 0x64, 0x00, 0x80,
	0x00, 0x00, 0x44, 0x88, 0x00, 0x20,
	0x40, 0xA8, 0x44, 0x88, 0x54, 0x88,
	0x40, 0xA8, 0xEC, 0x89, 0x54, 0x88,
	0x10, 0xBC, 0x64, 0x98, 0x7C, 0x88,
	0x44, 0x94, 0x6C, 0x9C, 0x68, 0x88,
	0x44, 0x6C, 0x6C, 0x9C, 0x9C, 0x88,
	0x14, 0xCC, 0xCC, 0xCC, 0xCC, 0x28,
	0x44, 0xCC, 0xCC, 0xCC, 0xCC, 0x88,
	0x44, 0xCC, 0x44, 0x88, 0xCC, 0xDC,
...
const u8 sprite_nave_left_up[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x14, 0xCC, 0xCC, 0xCC, 0xCC, 0x28,
	0x44, 0xCC, 0xCC, 0xCC, 0xCC, 0x88,
	0x44, 0xCC, 0xC4, 0xC8, 0xCC, 0xDC,
	0x00, 0xCC, 0xEC, 0xDC, 0xCC, 0xFC,
	0x00, 0x00, 0xA8, 0x54, 0x00, 0x00
};

const u8 sprite_nave_right[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x00, 0x14, 0x64, 0x98, 0x88, 0x00,
	0x00, 0x00, 0xCC, 0xCC, 0x00, 0x00,
	0x40, 0x00, 0x34, 0x38, 0x00, 0x00,
	0x40, 0x00, 0x98, 0x64, 0x00, 0x00,
	0x10, 0x00, 0x44, 0x88, 0x00, 0x00,
	0x44, 0x00, 0x44, 0x88, 0x00, 0x80,
	0x44, 0x00, 0xEC, 0x89, 0x00, 0x80,
	0x44, 0x14, 0x64, 0x98, 0x28, 0x20,
	0x44, 0x14, 0x6C, 0x9C, 0x28, 0x88,
	0x44, 0x6C, 0x6C, 0x9C, 0x9C, 0x88,
	0x14, 0xCC, 0xCC, 0xCC, 0xCC, 0x28,
	0x44, 0xCC, 0xCC, 0xCC, 0xCC, 0x88,
	0xEC, 0xCC, 0x44, 0x88, 0xCC, 0x88,
	0xFC, 0xCC, 0x44, 0x88, 0xCC, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

const u8 sprite_nave_right_down[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x40, 0x00, 0x98, 0x64, 0x00, 0x00,
	0x10, 0x00, 0x44, 0x88, 0x00, 0x00,
	0x44, 0xA8, 0x44, 0x88, 0x54, 0x80,
	0x44, 0xA8, 0xEC, 0x89, 0x54, 0x80,
	0x44, 0xBC, 0x64, 0x98, 0x7C, 0x20,
	0x44, 0x94, 0x6C, 0x9C, 0x68, 0x88,
	0x44, 0x6C, 0x6C, 0x9C, 0x9C, 0x88,
	0x14, 0xCC, 0xCC, 0xCC, 0xCC, 0x28,
	0x44, 0xCC, 0xCC, 0xCC, 0xCC, 0x88,
...
const u8 sprite_nave_right_up[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x14, 0xCC, 0xCC, 0xCC, 0xCC, 0x28,
	0x44, 0xCC, 0xCC, 0xCC, 0xCC, 0x88,
	0xEC, 0xCC, 0xC4, 0xC8, 0xCC, 0x88,
	0xFC, 0xCC, 0xEC, 0xDC, 0xCC, 0x00,
	0x00, 0x00, 0xA8, 0x54, 0x00, 0x00
};

const u8 sprite_nave_up[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x9C, 0xCC, 0xCC, 0xCC, 0xCC, 0x6C,
	0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
	0xCC, 0xCC, 0xC4, 0xC8, 0xCC, 0xCC,
	0x00, 0xCC, 0xEC, 0xDC, 0xCC, 0x00,
	0x00, 0x00, 0xA8, 0x54, 0x00, 0x00
};

const u8 sprite_nave_down[SHIP_WIDTH * SHIP_HEIGHT] = {
	0x00, 0x00, 0x14, 0x28, 0x00, 0x00,
	0x00, 0x00, 0x78, 0x34, 0x00, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x28, 0x00,
	0x00, 0x14, 0xF0, 0xF0, 0x88, 0x00,
	...
	0x80, 0x00, 0x98, 0x64, 0x00, 0x40,
	0x80, 0x00, 0x44, 0x88, 0x00, 0x40,
	0x20, 0xA8, 0x44, 0x88, 0x54, 0x10,
	0x88, 0xA8, 0xEC, 0x89, 0x54, 0x44,
	0x88, 0xBC, 0x64, 0x98, 0x7C, 0x44,
	0x88, 0x94, 0x6C, 0x9C, 0x68, 0x44,
	0x88, 0x6C, 0x6C, 0x9C, 0x9C, 0x44,
	0x9C, 0xCC, 0xCC, 0xCC, 0xCC, 0x6C,
	0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
	0xCC, 0xCC, 0x44, 0x88, 0xCC, 0xCC,
...
void ship_init(void) {
    ...
    ship.dy = 0;
    ship.dirty = 0;
    ship.sprite = sprite_nave;
}

void ship_update(void) {
    const u8 *new_sprite = NULL;
    ...
    case -1:
        switch (ship.dy) {
        case -2:
            new_sprite = sprite_nave_left_up;
            break;

        case 0:
            new_sprite = sprite_nave_left;
            break;

        case 2:
            new_sprite = sprite_nave_left_down;
            break;
        }
        break;
    ...
    case 0:
        switch (ship.dy) {
        case -2:
            new_sprite = sprite_nave_up;
            break;

        case 0:
            new_sprite = sprite_nave;
            break;

        case 2:
            new_sprite = sprite_nave_down;
            break;
        }
        break;
    ...
    case 1:
        switch (ship.dy) {
        case -2:
            new_sprite = sprite_nave_right_up;
            break;

        case 0:
            new_sprite = sprite_nave_right;
            break;

        case 2:
            new_sprite = sprite_nave_right_down;
            break;
        }
        break;
    ...
    if (ship.sprite != new_sprite) {
        ship.sprite = new_sprite;
        ship.dirty = 1;
    }
...
void ship_draw(void) {
    ...
    cpct_drawSprite(ship.sprite, p, SHIP_WIDTH, SHIP_HEIGHT);
    ship.ox = ship.x;
    ship.oy = ship.y;
    ship.dirty = 0;
}
